...
import {
  ...
  Github, Chrome, ArrowRight, Loader2,
} from "lucide-react";
  ...
  return (
    ...
    >
      <motion.div variants={fadeUp} className="text-center mb-8">
        ...
        <p className="text-[var(--muted-fg)] text-sm">Sign in to your account to continue</p>
      </motion.div>
      ...
      >
        ...
        <div className="grid grid-cols-2 gap-3 mb-6">
          <button
            ...
            className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl
                       border border-[var(--border-color)] bg-[var(--surface)] text-sm
                       font-medium hover:bg-[var(--surface-elevated)] transition-colors"
          >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          {serverError && (
            <div className="p-3 rounded-xl bg-[var(--destructive)]/10 border border-[var(--destructive)]/20
            ...
            <div className="relative">
              ...
              <input
                ...
                className={cn(
                  ...
                  errors.email ? "border-[var(--destructive)]/50" : "border-[var(--border-color)]"
                )}
              />
            </div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={cn(
                  ...
                  "placeholder:text-[var(--muted-fg)] outline-none transition-colors",
                  "focus:border-[var(--primary)]/50 focus:ring-2 focus:ring-[var(--primary)]/10",
                  errors.password ? "border-[var(--destructive)]/50" : "border-[var(--border-color)]"
                )}
              />
              <button
                type="button"
